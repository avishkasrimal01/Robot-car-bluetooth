...
#define light_FR  3    //LED Front Right   pin A0 for Arduino Uno
#define light_FL  4    //LED Front Left    pin A1 for Arduino Uno
#define light_BR  8    //LED Back Right    pin A2 for Arduino Uno
#define light_BL  9    //LED Back Left     pin A3 for Arduino Uno
#define horn_Buzz 2    //Horn Buzzer       pin A4 for Arduino Uno
